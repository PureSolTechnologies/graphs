...
public interface TreeNode<N extends TreeNode<N>> extends Vertex<N, TreeLink<N>> {
     ...
     * 
     * @return A {@link TreeNode} of T is returned. <code>null</code> is
     *         returned if no parent is present and the current node is the root
     *         node.
     */
    public N getParent();
     ...
     * of this interface {@link TreeNode} may have other values, too.
     * 
